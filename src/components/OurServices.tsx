        ...
        <div className="mt-16 flex flex-col-reverse items-center justify-between gap-10 lg:flex-row">
          <div className="flex w-full flex-col gap-5 lg:w-1/2 lg:gap-0">
            <div className="mx-auto flex w-full max-w-lg flex-col gap-4 lg:flex-row">
              <div className="border-l-pituku-primary order-2 mx-0 mt-5 flex h-full  w-full flex-col-reverse items-center gap-4 self-stretch lg:order-1 lg:w-auto">
              ...
              <div className="order-1 flex flex-col items-center lg:order-2 lg:flex-row lg:items-start lg:gap-4">
                <div className="mb-5">
                  <span className="bg-pituku-primary flex h-14 w-14 items-center justify-center rounded-full p-4 ring-4 ring-white">
                    <svg
                      width="50"
                      height="50"
                      viewBox="0 0 50 50"
            ...
            <div className="mx-auto flex w-full max-w-lg flex-col gap-4 lg:flex-row">
              <div className="border-l-pituku-primary order-1 mx-0 mt-5 hidden h-full w-full flex-col-reverse  items-center gap-4 self-stretch lg:flex lg:w-auto">
                <span>
                  <svg
                    width="30"
                    height="30"
